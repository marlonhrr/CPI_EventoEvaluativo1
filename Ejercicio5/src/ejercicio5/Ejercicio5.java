/*
5.      Declaración de una variable tipo cadena de caracteres.
 */
package ejercicio5;
...
public class Ejercicio5 {
    ...
    public static void main(String[] args) {
        ...
        //Inicio Ejercicio5
        String caracter = ".:: ¡Esto es una cadena de caracteres! ::.";
        System.out.println("_________________________________________");
        System.out.println("    La variable tipo cadena de caracteres ingresada es: " +caracter+"."); 
        System.out.println("_________________________________________");
        //Fin Ejercicio5
